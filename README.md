...
Non-opinionated tools for building API backends with the [OpenAPI standard](https://github.com/OAI/OpenAPI-Specification) previously known as Swagger.

You can use OpenAPI Backend to handle routing and/or input validation in any Node.js API backend.
